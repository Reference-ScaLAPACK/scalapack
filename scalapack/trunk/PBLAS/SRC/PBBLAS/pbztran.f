      SUBROUTINE PBZTRAN( ICONTXT, ADIST, TRANS, M, N, NB, A, LDA, BETA,
...
*=======================================================================
*
      SUBROUTINE PBZTR2AT( ICONTXT, ADIST, TRANS, M, N, NB, A, LDA,
...
*=======================================================================
*
      SUBROUTINE PBZTR2BT( ICONTXT, ADIST, TRANS, M, N, NB, A, LDA,
     $                     BETA, B, LDB, INTV )
*
*  -- PB-BLAS routine (version 2.1) --
*     University of Tennessee, Knoxville, Oak Ridge National Laboratory.
...
*=======================================================================
*
      SUBROUTINE PBZTR2AF( ICONTXT, ADIST, M, N, NB, A, LDA, BETA, B,
     $                     LDB, LCMP, LCMQ, NINT )
*
*  -- PB-BLAS routine (version 2.1) --
*     University of Tennessee, Knoxville, Oak Ridge National Laboratory.
