...
*  =======
*
*  PSAXPY  adds one subvector to another,
*
...
*/
   ...
   {
      PB_Cchkvec( ctxt, "PSAXPY", "X", *N, 1, Xi, Xj, Xd, *INCX,  6, &info );
      PB_Cchkvec( ctxt, "PSAXPY", "Y", *N, 1, Yi, Yj, Yd, *INCY, 11, &info );
   }
   if( info ) { PB_Cabort( ctxt, "PSAXPY", info ); return; }
#endif
/*
