...
*  =======
*
*  PDBLA1TIM  is the main timing program for the Level 1 PBLAS routines.
*
...
*     .. Local Scalars ..
     ...
     $                   PISCLR, RSRCX, RSRCY
      DOUBLE PRECISION   ADDS, ALPHA, CFLOPS, MULTS, NOPS, PSCLR,
     $                   PUSCLR, WFLOPS
*     ..
*     .. Local Arrays ..
...
*     .. External Subroutines ..
     ...
     $                   PB_TIMER, PDAMAX, PDASUM, PDAXPY,
     $                   PDBLA1TIMINFO, PDCOPY, PDDOT, PDLAGEN, PDNRM2,
     $                   PDSCAL, PDSWAP, PVDESCCHK, PVDIMCHK
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          DBLE
*     ..
...
*
      ...
      CALL PDBLA1TIMINFO( OUTFILE, NOUT, NTESTS, NVAL, MXVAL, NXVAL,
...
*
      END
      SUBROUTINE PDBLA1TIMINFO( SUMMRY, NOUT, NMAT, NVAL, MXVAL, NXVAL,
...
*  =======
*
*  PDBLA1TIMINFO  get  the needed startup information for timing various
...
*          MAX( 2, 2*NGRIDS+23*NMAT+NSUBS ) with NSUBS = 8.  This  array
...
*
         OPEN( NIN, FILE='PDBLAS1TIM.dat', STATUS='OLD' )
         READ( NIN, FMT = * ) SUMMRY
         SUMMRY = ' '
*
