      SUBROUTINE PSGERFS( TRANS, N, NRHS, A, IA, JA, DESCA, AF, IAF,
...
*     .. External Subroutines ..
     ...
     $                   PSGEMV, PSGETRS, PSLACON, PXERBLA,
...
*
     ...
     $                  IX, JX, DESCX, 20, 5, IDUM1, IDUM2, INFO )
      END IF
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PSGERFS', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
     ...
     $                DESCW, 1 )
         CALL PSGEMV( TRANS, N, N, -ONE, A, IA, JA, DESCA, X, IX,
...
*
   ...
   30          CONTINUE
         ...
         END IF
*
         CALL PSAGEMV( TRANS, N, N, ONE, A, IA, JA, DESCA, X, IX, JX+K,
...
*
            CALL PSGETRS( TRANS, N, 1, AF, IAF, JAF, DESCAF, IPIV,
...
*
               CALL PSGETRS( TRANST, N, 1, AF, IAF, JAF, DESCAF,
...
*
     ...
     $                   DESCW, 1 )
            CALL PSGEMV( TRANS, N, N, -ONE, A, IA, JA, DESCA, X,
...
*
  ...
  120             CONTINUE
            ...
            END IF
*
            CALL PSAGEMV( TRANS, N, N, ONE, A, IA, JA, DESCA, X, IX,
...
*
  ...
  170                   CONTINUE
                  ...
                  END IF
*
                  CALL PSGETRS( TRANS, N, 1, AF, IAF, JAF, DESCAF,
