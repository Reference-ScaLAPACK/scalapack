      SUBROUTINE PDORMR3( SIDE, TRANS, M, N, K, L, A, IA, JA, DESCA,
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_ABORT, BLACS_GRIDINFO, CHK1MAT, PDLARZ,
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PDORMR3', -INFO )
...
*        Apply H(i) or H(i)'
*
         CALL PDLARZ( SIDE, MI, NI, L, A, I, JAA, DESCA, DESCA( M_ ),
