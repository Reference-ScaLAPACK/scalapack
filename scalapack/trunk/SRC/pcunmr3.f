      SUBROUTINE PCUNMR3( SIDE, TRANS, M, N, K, L, A, IA, JA, DESCA,
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_ABORT, BLACS_GRIDINFO, CHK1MAT, PCLARZ,
     $                   PCLARZC, PB_TOPGET, PB_TOPSET, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PCUNMR3', -INFO )
...
*
         IF( NOTRAN ) THEN
            CALL PCLARZ( SIDE, MI, NI, L, A, I, JAA, DESCA, DESCA( M_ ),
     $                   TAU, C, ICC, JCC, DESCC, WORK )
         ELSE
            CALL PCLARZC( SIDE, MI, NI, L, A, I, JAA, DESCA,
