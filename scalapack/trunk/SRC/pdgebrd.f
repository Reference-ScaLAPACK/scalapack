...
*     .. External Subroutines ..
     ...
     $                   PDELSET, PDGEBD2, PDGEMM, PDLABRD,
...
*        part of the matrix.
*
         CALL PDLABRD( M-K+1, N-K+1, JB, A, I, J, DESCA, D, E, TAUQ,
...
*
         CALL PDGEMM( 'No transpose', 'No transpose', M-K-JB+1,
...
*
      CALL PDGEBD2( M-K+1, N-K+1, A, IA+K-1, JA+K-1, DESCA, D, E, TAUQ,
