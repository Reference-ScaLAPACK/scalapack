      SUBROUTINE PSDTSV( N, NRHS, DL, D, DU, JA, DESCA, B, IB, DESCB,
     $                   WORK, LWORK, INFO )
*
*
*
...
*     .. External Subroutines ..
      EXTERNAL           PSDTTRF, PSDTTRS, PXERBLA
*     ..
...
*     Factor the matrix
*
      CALL PSDTTRF( N, DL, D, DU, JA, DESCA, WORK,
...
*
      IF( INFO.NE.0 ) THEN
         IF( INFO .LT. 0 ) THEN
            CALL PXERBLA( ICTXT, 'PSDTSV', -INFO )
         ENDIF
         RETURN
      END IF
*
...
*
      CALL PSDTTRS( 'N', N, NRHS, DL, D, DU, JA, DESCA, B, IB, DESCB,
