...
*     .. External Subroutines ..
     ...
     $                   PZLACGV, PZLARFC, PZLASET, PZSCAL
*     ..
*     .. External Functions ..
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PZUNGR2', -INFO )
...
*
         CALL PZLASET( 'All', M-K, N-M, ZERO, ZERO, A, IA, JA, DESCA )
         CALL PZLASET( 'All', M-K, M, ZERO, ONE, A, IA, JA+N-M, DESCA )
*
      END IF
*
      TAUI = ZERO
...
*
         CALL PZLACGV( I-IA+N-M, A, I, JA, DESCA, DESCA( M_ ) )
         CALL PZELSET( A, I, JA+N-M+I-IA, DESCA, ONE )
         CALL PZLARFC( 'Right', I-IA, I-IA+N-M+1, A, I, JA, DESCA,
     ...
     $                    NPROW )
         IF( MYROW.EQ.IAROW )
     $      TAUI = TAU( MIN( II, MP ) )
         CALL PZSCAL( I-IA+N-M, -TAUI, A, I, JA, DESCA, DESCA( M_ ) )
         CALL PZLACGV( I-IA+N-M, A, I, JA, DESCA, DESCA( M_ ) )
         CALL PZELSET( A, I, JA+N-M+I-IA, DESCA, ONE-DCONJG( TAUI ) )
*
*        Set A(i,ja+n-m+i-ia+1:ja+n-1) to zero
*
         CALL PZLASET( 'All', 1, IA+M-1-I, ZERO, ZERO, A, I,
     $                 JA+N-M+I-IA+1, DESCA )
*
   10 CONTINUE
*
