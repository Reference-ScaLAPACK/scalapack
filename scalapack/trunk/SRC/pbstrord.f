...
*     .. Local Scalars ..
     ...
     $                   UPDATE, ISHH, FIRST, SKIP1CR, BORDER,
     $                   LASTWAIT
      INTEGER            NPROW, NPCOL, MYROW, MYCOL, NB, NPROCS,
     $                   IERR, KKK, LLL, DB, DIM1, INDX,
     ...
     $                   PITRAF, PDW, WINEIG, WINSIZ, LLDQ, RINDX,
...
*
                        CALL SLASET( 'All', NWIN, NWIN, ZERO, ONE,
     $                       WORK( IPW4 ), NWIN )
                        WORK(IPW8) = REAL(MYROW)
                        WORK(IPW8+1) = REAL(MYCOL)
