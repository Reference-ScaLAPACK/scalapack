      SUBROUTINE PZUNGL2( M, N, K, A, IA, JA, DESCA, TAU, WORK, LWORK,
     $                    INFO )
*
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PZUNGL2', -INFO )
...
*
         CALL PZLASET( 'All', M-K, K, ZERO, ZERO, A, IA+K, JA, DESCA )
         CALL PZLASET( 'All', M-K, N-K, ZERO, ONE, A, IA+K, JA+K,
     $                 DESCA )
*
      END IF
*
     ...
     $      TAUI = TAU( MIN( II, KP ) )
         IF( J.LT.JA+N-1 ) THEN
            ...
            IF( I.LT.IA+M-1 ) THEN
               ...
               CALL PZLARFC( 'Right', M-I+IA-1, N-J+JA, A, I, J, DESCA,
     $                       DESCA( M_ ), TAU, A, I+1, J, DESCA, WORK )
            END IF
            CALL PZSCAL( N-J+JA-1, -TAUI, A, I, J+1, DESCA,
     $                        DESCA( M_ ) )
            CALL PZLACGV( N-J+JA-1, A, I, J+1, DESCA, DESCA( M_ ) )
         END IF
         CALL PZELSET( A, I, J, DESCA, ONE-DCONJG( TAUI ) )
*
