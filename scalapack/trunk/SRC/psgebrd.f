...
*     .. External Subroutines ..
     ...
     $                   PSELSET, PSGEBD2, PSGEMM, PSLABRD,
...
*        part of the matrix.
*
         CALL PSLABRD( M-K+1, N-K+1, JB, A, I, J, DESCA, D, E, TAUQ,
...
*
         CALL PSGEMM( 'No transpose', 'No transpose', M-K-JB+1,
...
*
      CALL PSGEBD2( M-K+1, N-K+1, A, IA+K-1, JA+K-1, DESCA, D, E, TAUQ,
