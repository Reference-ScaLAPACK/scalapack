      SUBROUTINE PZDBSV( N, BWL, BWU, NRHS, A, JA, DESCA, B, IB, DESCB,
     $                   WORK, LWORK, INFO )
*
*
*
...
*     .. External Subroutines ..
      EXTERNAL           PXERBLA, PZDBTRF, PZDBTRS
*     ..
...
*     Factor the matrix
*
      CALL PZDBTRF( N, BWL, BWU, A, JA, DESCA, WORK,
...
*
      IF( INFO.NE.0 ) THEN
         IF( INFO .LT. 0 ) THEN
            CALL PXERBLA( ICTXT, 'PZDBSV', -INFO )
         ENDIF
         RETURN
      END IF
*
...
*
      CALL PZDBTRS( 'N', N, BWL, BWU, NRHS, A, JA, DESCA, B, IB, DESCB,
