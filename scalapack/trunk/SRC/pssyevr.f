...
*           Has already been computed by SMPIM2 and stored
...
*     =======
*
*     SMPIM2 is the scheduling subroutine.
...
*     =======
*
*     Using the output from SMPIM2 and given the information on
*     eigenvalue clusters, SMPCOL finds the collaborators of MYPROC.
*
*     Arguments
*     =========
*
