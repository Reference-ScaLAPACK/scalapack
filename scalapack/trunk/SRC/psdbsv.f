...
*     .. External Subroutines ..
      EXTERNAL           PSDBTRF, PSDBTRS, PXERBLA
*     ..
...
*     Factor the matrix
*
      CALL PSDBTRF( N, BWL, BWU, A, JA, DESCA, WORK,
...
*
      IF( INFO.NE.0 ) THEN
         IF( INFO .LT. 0 ) THEN
            CALL PXERBLA( ICTXT, 'PSDBSV', -INFO )
         ENDIF
         RETURN
      END IF
*
...
*
      CALL PSDBTRS( 'N', N, BWL, BWU, NRHS, A, JA, DESCA, B, IB, DESCB,
