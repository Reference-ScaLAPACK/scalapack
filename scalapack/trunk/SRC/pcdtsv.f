...
*  =======
*
*  PCDTSV solves a system of linear equations
*
...
*     .. External Subroutines ..
      EXTERNAL           PCDTTRF, PCDTTRS, PXERBLA
*     ..
...
*     Factor the matrix
*
      CALL PCDTTRF( N, DL, D, DU, JA, DESCA, WORK,
...
*
      IF( INFO.NE.0 ) THEN
         IF( INFO .LT. 0 ) THEN
            CALL PXERBLA( ICTXT, 'PCDTSV', -INFO )
         ENDIF
         RETURN
      END IF
*
...
*
      CALL PCDTTRS( 'N', N, NRHS, DL, D, DU, JA, DESCA, B, IB, DESCB,
