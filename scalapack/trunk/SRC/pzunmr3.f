      SUBROUTINE PZUNMR3( SIDE, TRANS, M, N, K, L, A, IA, JA, DESCA,
...
*     .. External Subroutines ..
     ...
     $                   PB_TOPGET, PB_TOPSET, PXERBLA, PZLARZ, PZLARZC
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PZUNMR3', -INFO )
...
*
         IF( NOTRAN ) THEN
            CALL PZLARZ( SIDE, MI, NI, L, A, I, JAA, DESCA, DESCA( M_ ),
     $                   TAU, C, ICC, JCC, DESCC, WORK )
         ELSE
            CALL PZLARZC( SIDE, MI, NI, L, A, I, JAA, DESCA,
