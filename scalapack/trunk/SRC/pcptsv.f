      SUBROUTINE PCPTSV( UPLO, N, NRHS, D, E, JA, DESCA, B, IB, DESCB,
     $                   WORK, LWORK, INFO )
*
*
*
...
*     .. External Subroutines ..
      EXTERNAL           PCPTTRF, PCPTTRS, PXERBLA
*     ..
...
*     Factor the matrix
*
      CALL PCPTTRF( N, D, E, JA, DESCA, WORK, MIN( LWORK, WS_FACTOR ),
...
*
      IF( INFO.NE.0 ) THEN
         IF( INFO .LT. 0 ) THEN
            CALL PXERBLA( ICTXT, 'PCPTSV', -INFO )
         ENDIF
         RETURN
      END IF
*
...
*
      CALL PCPTTRS( UPLO, N, NRHS, D, E, JA, DESCA, B, IB, DESCB, WORK,
