...
*  =======
*
*  PCLATRZ reduces the M-by-N ( M<=N ) complex upper trapezoidal
...
*     .. External Subroutines ..
      EXTERNAL           DESCSET, INFOG1L, PCELSET, PCLACGV,
     $                   PCLARFG, PCLARZ
*     ..
*     .. External Functions ..
      INTEGER            NUMROC
...
*           [ A(i, j) A(i,j1:ja+n-1) ]
*
            CALL PCLACGV( 1, A, I, J, DESCA, DESCA( M_ ) )
...
*
            CALL PCLARZ( 'Right', I-IA, JA+N-J, L, A, I, J1, DESCA,
     $                   DESCA( M_ ), TAU, A, IA, J, DESCA, WORK )
            CALL PCELSET( A, I, J, DESCA, CONJG( AII ) )
*
   20    CONTINUE
*
         CALL PCLACGV( M, TAU, IA, 1, DESCTAU, 1 )
*
      END IF
*
      RETURN
