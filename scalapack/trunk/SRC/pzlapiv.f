...
*     .. External Subroutines ..
     ...
     $                   INFOG2L, PICOL2ROW, PIROW2COL, PZLAPV2
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
         IF( LSAME( PIVROC, 'C' ) ) THEN
            CALL PZLAPV2( DIREC, ROWCOL, M, N, A, IA, JA, DESCA, IPIV,
     $                    IP, JP, DESCIP )
*
*        Otherwise, we must redistribute IPIV to match PZLAPV2
*
         ELSE
*
...
*
   ...
   10       CONTINUE
            CALL PZLAPV2( DIREC, ROWCOL, M, N, A, IA, JA, DESCA, IWORK,
     $                    IPT, 1, DESCPT )
         END IF
*
