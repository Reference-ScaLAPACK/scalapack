      SUBROUTINE PCDBSV( N, BWL, BWU, NRHS, A, JA, DESCA, B, IB, DESCB,
     $                   WORK, LWORK, INFO )
*
*
*
...
*     .. External Subroutines ..
      EXTERNAL           PCDBTRF, PCDBTRS, PXERBLA
*     ..
...
*     Factor the matrix
*
      CALL PCDBTRF( N, BWL, BWU, A, JA, DESCA, WORK,
...
*
      IF( INFO.NE.0 ) THEN
         IF( INFO .LT. 0 ) THEN
            CALL PXERBLA( ICTXT, 'PCDBSV', -INFO )
         ENDIF
         RETURN
      END IF
*
...
*
      CALL PCDBTRS( 'N', N, BWL, BWU, NRHS, A, JA, DESCA, B, IB, DESCB,
