      SUBROUTINE PCPOSV( UPLO, N, NRHS, A, IA, JA, DESCA, B, IB, JB,
     $                   DESCB, INFO )
*
...
*  =======
*
*  PCPOSV computes the solution to a complex system of linear equations
*
*                        sub( A ) * X = sub( B ),
*
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK2MAT, PCPOTRF,
     $                   PCPOTRS, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PCPOSV', -INFO )
         RETURN
      END IF
*
...
*        with X.
*
         CALL PCPOTRS( UPLO, N, NRHS, A, IA, JA, DESCA, B, IB, JB,
     $                 DESCB, INFO )
*
      END IF
*
