...
*  =======
*
*  PZELGET sets alpha to the distributed matrix entry A( IA, JA ).
...
*
*  ALPHA   (global output) COMPLEX*16, the scalar alpha.
*
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, INFOG2L, ZGEBR2D, ZGEBS2D
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      EXTERNAL           LSAME
