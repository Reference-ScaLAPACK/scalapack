      SUBROUTINE PCLUINFO( SUMMRY, NOUT, NMAT, MVAL, NVAL, LDNVAL, NNB,
...
*  =======
*
*  PCLUINFO gets needed startup information for LU factorization
...
*
     ...
     $               'complex single precision LU factorization '//
     $               'and solve.'
         WRITE( NOUT, FMT = 9999 )
