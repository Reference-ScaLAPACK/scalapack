      SUBROUTINE PDLLTINFO( SUMMRY, NOUT, UPLO, NMAT, NVAL, LDNVAL, NNB,
...
*  =======
*
*  PDLLTINFO get needed startup information for LLt factorization
...
*
     ...
     $                   'real double precision LLt factorization '//
     $                   'and solve.'
         WRITE( NOUT, FMT = 9999 )
