      SUBROUTINE PZLSINFO( SUMMRY, NOUT, NMAT, MVAL, LDMVAL,
     $                     NVAL, LDNVAL, NNB, NBVAL, LDNBVAL, NNR,
...
*     .. Scalar Arguments ..
      CHARACTER*( * )    SUMMRY
      INTEGER            IAM, LDMVAL, LDNBRVAL, LDNBVAL, LDNRVAL,
     $                   LDNVAL, LDPVAL, LDQVAL, NGRIDS, NMAT, NNB,
     $                   NNBR, NNR, NOUT, NPROCS
      REAL               THRESH
*     ..
*     .. Array Arguments ..
      INTEGER            MVAL( LDMVAL ), NBRVAL( LDNBRVAL ),
...
*  =======
*
*  PZLSINFO gets needed startup information for LS solve and
...
*
*  WORK     (workspace) INTEGER array of dimension >=
*            MAX(5,LDMVAL+LDNVAL+LDNBVAL+LDNRVAL+LDNBRVAL+LDPVAL+LDQVAL)
...
*
         OPEN( NIN, FILE='LS.dat', STATUS='OLD' )
         READ( NIN, FMT = * ) SUMMRY
         SUMMRY = ' '
*
...
*
     ...
     $               'complex single precision least-square solve.'
         WRITE( NOUT, FMT = 9999 )
