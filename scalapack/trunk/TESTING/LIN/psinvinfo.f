      SUBROUTINE PSINVINFO( SUMMRY, NOUT, NMTYP, MATTYP, LDMTYP, NMAT,
...
*  =======
*
*  PSINVINFO gets needed startup information for matrix inversion
...
*
     ...
     $               'real single precision Matrix Inversion '//
     $               'routines.'
         WRITE( NOUT, FMT = 9999 )
