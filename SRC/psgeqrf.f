...
*  =======
*
*  PSGEQRF computes a QR factorization of a real distributed M-by-N
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK1MAT, PSGEQR2,
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PSGEQRF', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
      CALL PSGEQR2( M, JB, A, IA, JA, DESCA, TAU, WORK, LWORK, IINFO )
*
...
*
         CALL PSLARFB( 'Left', 'Transpose', 'Forward', 'Columnwise', M,
...
*        A(i:ia+m-1,j:j+jb-1)
*
         CALL PSGEQR2( M-J+JA, JB, A, I, J, DESCA, TAU, WORK, LWORK,
     $                 IINFO )
*
...
*
            CALL PSLARFT( 'Forward', 'Columnwise', M-J+JA, JB, A, I, J,
