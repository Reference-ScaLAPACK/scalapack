      SUBROUTINE PZUNML2( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PZUNML2', -INFO )
...
*
     ...
     $                    DESCA( M_ ) )
         CALL PZELSET2( AII, A, I, JA+I-IA, DESCA, ONE )
         IF( NOTRAN ) THEN
            CALL PZLARFC( SIDE, MI, NI, A, I, JA+I-IA, DESCA,
     $                    DESCA( M_ ), TAU, C, ICC, JCC, DESCC, WORK )
         ELSE
            CALL PZLARF( SIDE, MI, NI, A, I, JA+I-IA, DESCA,
     $                   DESCA( M_ ), TAU, C, ICC, JCC, DESCC, WORK )
         END IF
         CALL PZELSET( A, I, JA+I-IA, DESCA, AII )
         IF( I-IA+1.LT.NQ )
     $      CALL PZLACGV( NQ-I+IA-1, A, I, JA+I-IA+1, DESCA,
     $                    DESCA( M_ ) )
*
