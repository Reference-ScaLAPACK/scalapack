      SUBROUTINE PDDTTRS( TRANS, N, NRHS, DL, D, DU, JA, DESCA, B, IB,
...
*     .. External Subroutines ..
     ...
     $                   GLOBCHK, PDDTTRSV, PXERBLA, RESHAPE
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      INTEGER            NUMROC
...
*
      IF( LSAME( TRANS, 'N' ) ) THEN
*
         CALL PDDTTRSV( 'L', 'N', N, NRHS, DL( PART_OFFSET+1 ),
...
*
      ELSE
*
         CALL PDDTTRSV( 'U', 'T', N, NRHS, DL( PART_OFFSET+1 ),
     $                  D( PART_OFFSET+1 ), DU( PART_OFFSET+1 ), JA_NEW,
     $                  DESCA_1XP, B, IB, DESCB_PX1, AF, LAF, WORK,
     $                  LWORK, INFO )
*
...
*
         CALL PDDTTRSV( 'L', 'T', N, NRHS, DL( PART_OFFSET+1 ),
     $                  D( PART_OFFSET+1 ), DU( PART_OFFSET+1 ), JA_NEW,
     $                  DESCA_1XP, B, IB, DESCB_PX1, AF, LAF, WORK,
     $                  LWORK, INFO )
*
      ELSE
*
         CALL PDDTTRSV( 'U', 'N', N, NRHS, DL( PART_OFFSET+1 ),
     $                  D( PART_OFFSET+1 ), DU( PART_OFFSET+1 ), JA_NEW,
     $                  DESCA_1XP, B, IB, DESCB_PX1, AF, LAF, WORK,
     $                  LWORK, INFO )
*
