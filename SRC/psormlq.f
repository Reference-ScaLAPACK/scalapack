      SUBROUTINE PSORMLQ( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,
...
*     .. External Subroutines ..
     ...
     $                   PSLARFT, PSORML2, PB_TOPGET, PB_TOPSET, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PSORMLQ', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
         CALL PSLARFT( 'Forward', 'Rowwise', NQ-I+IA, IB, A, I, JA+I-IA,
...
*        Apply H or H'
*
         CALL PSLARFB( SIDE, TRANST, 'Forward', 'Rowwise', MI, NI, IB,
