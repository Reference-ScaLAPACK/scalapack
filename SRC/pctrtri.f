...
*     .. External Subroutines ..
     ...
     $                   PCHK1MAT, PCTRTI2, PCTRMM, PCTRSM,
     $                   PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PCTRTRI', -INFO )
         RETURN
      END IF
*
...
*
         CALL PCTRTI2( UPLO, DIAG, JB, A, IA, JA, DESCA, INFO )
*
...
*
            CALL PCTRMM( 'Left', UPLO, 'No transpose', DIAG, J-JA, JB,
     $                   ONE, A, IA, JA, DESCA, A, IA, J, DESCA )
            CALL PCTRSM( 'Right', UPLO, 'No transpose', DIAG, J-JA,
     $                   JB, -ONE, A, I, J, DESCA, A, IA, J, DESCA )
*
*           Compute inverse of current diagonal block
*
            CALL PCTRTI2( UPLO, DIAG, JB, A, I, J, DESCA, INFO )
*
   40    CONTINUE
*
      ELSE
...
*
               CALL PCTRMM( 'Left', UPLO, 'No transpose', DIAG,
     $                      JA+N-J-JB, JB, ONE, A, I+JB, J+JB, DESCA,
     $                      A, I+JB, J, DESCA )
               CALL PCTRSM( 'Right', UPLO, 'No transpose', DIAG,
...
*
            CALL PCTRMM( 'Left', UPLO, 'No transpose', DIAG, N-JB, JB,
     $                   ONE, A, IA+JB, JA+JB, DESCA, A, IA+JB, JA,
     $                   DESCA )
            CALL PCTRSM( 'Right', UPLO, 'No transpose', DIAG, N-JB, JB,
