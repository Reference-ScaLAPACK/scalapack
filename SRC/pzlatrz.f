...
*  =======
*
*  PZLATRZ reduces the M-by-N ( M<=N ) complex upper trapezoidal
...
*     .. External Subroutines ..
      EXTERNAL           DESCSET, INFOG1L, PZELSET, PZLACGV,
     $                   PZLARFG, PZLARZ
*     ..
*     .. External Functions ..
      INTEGER            NUMROC
...
*           [ A(i, j) A(i,j1:ja+n-1) ]
*
            CALL PZLACGV( 1, A, I, J, DESCA, DESCA( M_ ) )
...
*
            CALL PZLARZ( 'Right', I-IA, JA+N-J, L, A, I, J1, DESCA,
     $                   DESCA( M_ ), TAU, A, IA, J, DESCA, WORK )
            CALL PZELSET( A, I, J, DESCA, DCONJG( AII ) )
*
   20    CONTINUE
*
         CALL PZLACGV( M, TAU, IA, 1, DESCTAU, 1 )
*
      END IF
*
      RETURN
