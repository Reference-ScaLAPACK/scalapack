      SUBROUTINE PZGELQ2( M, N, A, IA, JA, DESCA, TAU, WORK, LWORK,
     $                    INFO )
*
...
*  =======
*
*  PZGELQ2 computes a LQ factorization of a complex distributed M-by-N
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PZGELQ2', -INFO )
...
*        A(i,j+1:ja+n-1)
*
         CALL PZLACGV( N-J+JA, A, I, J, DESCA, DESCA( M_ ) )
         CALL PZLARFG( N-J+JA, AII, I, J, A, I, MIN( J+1, JA+N-1 ),
     $                 DESCA, DESCA( M_ ), TAU )
*
         IF( I.LT.IA+M-1 ) THEN
*
...
*
            ...
            CALL PZLARF( 'Right', M-I+IA-1, N-J+JA, A, I, J, DESCA,
     $                   DESCA( M_ ), TAU, A, I+1, J, DESCA, WORK )
         END IF
         CALL PZELSET( A, I, J, DESCA, AII )
         CALL PZLACGV( N-J+JA, A, I, J, DESCA, DESCA( M_ ) )
*
   10 CONTINUE
*
