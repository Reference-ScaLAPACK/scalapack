      SUBROUTINE SLARRB_CV( N, D, LLD, IFIRST, ILAST, RTOL1,
...
*	 
         BACK = WERR( II )
 20      CONTINUE
         NEGCNT = SLANEG_CV( N, D, LLD, LEFT, PIVMIN, R )
...
*	 
 ...
 50      CONTINUE
         ...
         NEGCNT = SLANEG_CV( N, D, LLD, RIGHT, PIVMIN, R )
         IF( NEGCNT.LT.I ) THEN
             RIGHT = RIGHT + BACK
             BACK = TWO*BACK
             GO TO 50
...
*
         NEGCNT = SLANEG_CV( N, D, LLD, MID, PIVMIN, R )
...
*
*
      FUNCTION SLANEG_CV( N, D, LLD, SIGMA, PIVMIN, R )
      INTEGER SLANEG_CV
*
*     .. Scalar Arguments ..
      INTEGER            N, R
