      SUBROUTINE PSORM2R( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PSORM2R', -INFO )
...
*           Apply H(j) or H(j)'
*
            CALL PSELSET2( AJJ, A, IA+J-JA, J, DESCA, ONE )
            CALL PSLARF( SIDE, MI, NI, A, IA+J-JA, J, DESCA, 1, TAU, C,
     $                   ICC, JCC, DESCC, WORK )
            CALL PSELSET( A, IA+J-JA, J, DESCA, AJJ )
*
   10    CONTINUE
*
