...
*     .. External Subroutines ..
     ...
     $                   PB_TOPSET, PXERBLA, PZGEQR2, PZLARFB,
     $                   PZLARFT
*     ..
*     .. External Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PZGEQRF', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
      CALL PZGEQR2( M, JB, A, IA, JA, DESCA, TAU, WORK, LWORK, IINFO )
*
...
*        A(i:ia+m-1,j:j+jb-1)
*
         CALL PZGEQR2( M-J+JA, JB, A, I, J, DESCA, TAU, WORK, LWORK,
     $                 IINFO )
*
...
*
            CALL PZLARFT( 'Forward', 'Columnwise', M-J+JA, JB, A, I, J,
