...
*  =======
*
*  PSLAWIL gets the transform given by H44,H33, & H43H34 into V
*     starting at row M.
*
*  Notes
*  =====
...
*          Unchanged on exit.
*
*  V       (global output) REAL array of size 3.
*          Contains the transform on output.
*
...
*
     ...
     $                    IROW, ICOL, RSRC, JSRC )
            ...
            CALL SGESD2D( CONTXT, 1, 1, BUF, 1, II, JJ )
         END IF
     ...
     $                    ICOL, RSRC, JSRC )
            ...
            CALL SGESD2D( CONTXT, 4, 1, BUF, 4, II, JJ )
         END IF
     ...
     $        THEN
            CALL INFOG2L( M, M, DESCA, NPROW, NPCOL, MYROW, MYCOL, IROW,
     $                    ICOL, RSRC, JSRC )
            CALL SGESD2D( CONTXT, 1, 1, A( ( ICOL-1 )*LDA+IROW ), 1, II,
     $                    JJ )
         END IF
