      SUBROUTINE PZPTSV( UPLO, N, NRHS, D, E, JA, DESCA, B, IB, DESCB,
     $                   WORK, LWORK, INFO )
*
*
*
...
*     .. External Subroutines ..
      EXTERNAL           PXERBLA, PZPTTRF, PZPTTRS
*     ..
...
*     Factor the matrix
*
      CALL PZPTTRF( N, D, E, JA, DESCA, WORK, MIN( LWORK, WS_FACTOR ),
...
*
      IF( INFO.NE.0 ) THEN
         IF( INFO .LT. 0 ) THEN
            CALL PXERBLA( ICTXT, 'PZPTSV', -INFO )
         ENDIF
         RETURN
      END IF
*
...
*
      CALL PZPTTRS( UPLO, N, NRHS, D, E, JA, DESCA, B, IB, DESCB, WORK,
