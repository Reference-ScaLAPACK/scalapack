      SUBROUTINE PSORML2( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PSORML2', -INFO )
...
*        Apply H(i) or H(i)'
*
         CALL PSELSET2( AII, A, I, JA+I-IA, DESCA, ONE )
         CALL PSLARF( SIDE, MI, NI, A, I, JA+I-IA, DESCA, DESCA( M_ ),
     $                TAU, C, ICC, JCC, DESCC, WORK )
         CALL PSELSET( A, I, JA+I-IA, DESCA, AII )
*
   10 CONTINUE
*
      CALL PB_TOPGET( ICTXT, 'Broadcast', 'Rowwise', ROWBTOP )
