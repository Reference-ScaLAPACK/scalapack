      SUBROUTINE PCUNMLQ( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,
...
*     .. External Subroutines ..
     ...
     $                   PCLARFT, PCUNML2, PB_TOPGET, PB_TOPSET, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PCUNMLQ', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
     ...
     $   CALL PCUNML2( SIDE, TRANS, M, N, I1-IA, A, IA, JA, DESCA, TAU,
...
*
         CALL PCLARFT( 'Forward', 'Rowwise', NQ-I+IA, IB, A, I, JA+I-IA,
...
*        Apply H or H'
*
         CALL PCLARFB( SIDE, TRANST, 'Forward', 'Rowwise', MI, NI, IB,
     $                 A, I, JA+I-IA, DESCA, WORK, C, ICC, JCC, DESCC,
     $                 WORK( IPW ) )
   10 CONTINUE
*
      IF( ( LEFT .AND. .NOT.NOTRAN ) .OR. ( .NOT.LEFT .AND. NOTRAN ) )
     $   CALL PCUNML2( SIDE, TRANS, M, N, I2-IA, A, IA, JA, DESCA, TAU,
     $                 C, IC, JC, DESCC, WORK, LWORK, IINFO )
*
