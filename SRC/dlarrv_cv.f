      SUBROUTINE DLARRV_CV( N, VL, VU, D, L, PIVMIN,
...
*     .. External Subroutines ..
      EXTERNAL           DAXPY, DCOPY, DLAR1V_CV, DLARRB_CV, DLARRF_CV,
     $                   DLASET, DSCAL
*     ..
*     .. Intrinsic Functions ..
...
C                    DLARRF needs LWORK = 2*N
                     CALL DLARRF_CV( IN, D( IBEGIN ), L( IBEGIN ),
     $                         WORK(INDLD+IBEGIN-1), 
...
*                    Given LAMBDA, compute the eigenvector.
                     CALL DLAR1V_CV( IN, 1, IN, LAMBDA, D( IBEGIN ),
