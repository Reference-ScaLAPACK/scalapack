      SUBROUTINE PDLARZT( DIRECT, STOREV, N, K, V, IV, JV, DESCV, TAU,
     $                    T, WORK )
*
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_ABORT, BLACS_GRIDINFO, DCOPY, DGEMV,
     $                   DGSUM2D, DLASET, DTRMV, INFOG2L,
     $                   PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PDLARZT', -INFO )
...
*
            ITMP0 = ITMP0 + 1
            IF( NQ.GT.0 ) THEN
               CALL DGEMV( 'No transpose', ITMP0, NQ, -TAU( II ),
...
*
               ...
               IW = IW + ITMP0
*
               CALL DTRMV( 'Lower', 'No transpose', 'Non-unit', ITMP0,
