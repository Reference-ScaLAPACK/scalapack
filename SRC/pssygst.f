*
*
      SUBROUTINE PSSYGST( IBTYPE, UPLO, N, A, IA, JA, DESCA, B, IB, JB,
     $                    DESCB, SCALE, INFO )
*
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK2MAT, PSSYGS2,
     $                   PSSYMM, PSSYR2K, PSTRMM, PSTRSM, PXERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PSSYGST', -INFO )
         RETURN
      END IF
*
...
*
            CALL PSSYGS2( IBTYPE, UPLO, KB, A, IA+K-1, JA+K-1, DESCA, B,
     $                    IB+K-1, IB+K-1, DESCB, INFO )
            IF( K+KB.LE.N ) THEN
               CALL PSTRSM( 'Left', UPLO, 'Transpose', 'Non-unit', KB,
     $                      N-K-KB+1, ONE, B, IB+K-1, JB+K-1, DESCB, A,
     $                      IA+K-1, JA+K+KB-1, DESCA )
               CALL PSSYMM( 'Left', UPLO, KB, N-K-KB+1, -HALF, A,
     $                      IA+K-1, JA+K-1, DESCA, B, IB+K-1, JB+K+KB-1,
     $                      DESCB, ONE, A, IA+K-1, JA+K+KB-1, DESCA )
               CALL PSSYR2K( UPLO, 'Transpose', N-K-KB+1, KB, -ONE, A,
     ...
     $                      IA+K-1, JA+K-1, DESCA, B, IB+K-1, JB+K+KB-1,
     $                      DESCB, ONE, A, IA+K-1, JA+K+KB-1, DESCA )
               CALL PSTRSM( 'Right', UPLO, 'No transpose', 'Non-unit',
...
*
     ...
     $                      IA+K-1, JA+K-1, DESCA, B, IB+K+KB-1, JB+K-1,
     $                      DESCB, ONE, A, IA+K+KB-1, JA+K-1, DESCA )
               CALL PSTRSM( 'Left', UPLO, 'No transpose', 'Non-unit',
...
*
            CALL PSTRMM( 'Left', UPLO, 'No transpose', 'Non-unit', K-1,
     $                   KB, ONE, B, IB, JB, DESCB, A, IA, JA+K-1,
     $                   DESCA )
            CALL PSSYMM( 'Right', UPLO, K-1, KB, HALF, A, IA+K-1,
     $                   JA+K-1, DESCA, B, IB, JB+K-1, DESCB, ONE, A,
     $                   IA, JA+K-1, DESCA )
            CALL PSSYR2K( UPLO, 'No transpose', K-1, KB, ONE, A, IA,
     $                    JA+K-1, DESCA, B, IB, JB+K-1, DESCB, ONE, A,
     $                    IA, JA, DESCA )
            CALL PSSYMM( 'Right', UPLO, K-1, KB, HALF, A, IA+K-1,
     $                   JA+K-1, DESCA, B, IB, JB+K-1, DESCB, ONE, A,
     $                   IA, JA+K-1, DESCA )
            CALL PSTRMM( 'Right', UPLO, 'Transpose', 'Non-unit', K-1,
...
*
            CALL PSTRMM( 'Right', UPLO, 'No transpose', 'Non-unit', KB,
     $                   K-1, ONE, B, IB, JB, DESCB, A, IA+K-1, JA,
     $                   DESCA )
            CALL PSSYMM( 'Left', UPLO, KB, K-1, HALF, A, IA+K-1, JA+K-1,
     $                   DESCA, B, IB+K-1, JB, DESCB, ONE, A, IA+K-1,
     $                   JA, DESCA )
            CALL PSSYR2K( UPLO, 'Transpose', K-1, KB, ONE, A, IA+K-1,
     $                    JA, DESCA, B, IB+K-1, JB, DESCB, ONE, A, IA,
     $                    JA, DESCA )
            CALL PSSYMM( 'Left', UPLO, KB, K-1, HALF, A, IA+K-1, JA+K-1,
     $                   DESCA, B, IB+K-1, JB, DESCB, ONE, A, IA+K-1,
     $                   JA, DESCA )
            CALL PSTRMM( 'Left', UPLO, 'Transpose', 'Non-unit', KB, K-1,
