      SUBROUTINE PCUNMQR( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,
...
*
     ...
     $   CALL PCUNM2R( SIDE, TRANS, M, N, J1-JA, A, IA, JA, DESCA, TAU,
...
*
     ...
     $   CALL PCUNM2R( SIDE, TRANS, M, N, J2-JA, A, IA, JA, DESCA, TAU,
     $                 C, IC, JC, DESCC, WORK, LWORK, IINFO )
*
