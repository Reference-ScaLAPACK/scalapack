      SUBROUTINE DTRMVT( UPLO, N, T, LDT, X, INCX, Y, INCY, W, INCW, Z,
     $                   INCZ )
      IMPLICIT NONE
*
...
*  =======
*
*  DTRMVT  performs the matrix-vector operations
*
*     x := T' *y, and w := T *z,
*
...
*
     ...
     $    .TRUE. ) THEN
         CALL DCOPY( N, Y, INCY, X, INCX )
         CALL DTRMV( UPLO, 'C', 'N', N, T, LDT, X, INCX )
         CALL DCOPY( N, Z, INCZ, W, INCW )
         CALL DTRMV( UPLO, 'N', 'N', N, T, LDT, W, INCW )
         RETURN
      END IF
*
      RETURN
