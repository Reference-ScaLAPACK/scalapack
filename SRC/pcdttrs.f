      SUBROUTINE PCDTTRS( TRANS, N, NRHS, DL, D, DU, JA, DESCA, B, IB,
...
*
      IF( INFO.LT.0 ) THEN
         CALL PXERBLA( ICTXT, 'PCDTTRS', -INFO )
         RETURN
      END IF
*
...
*
      IF( LSAME( TRANS, 'N' ) ) THEN
*
         CALL PCDTTRSV( 'L', 'N', N, NRHS, DL( PART_OFFSET+1 ),
...
*
      ELSE
*
         CALL PCDTTRSV( 'U', 'C', N, NRHS, DL( PART_OFFSET+1 ),
     $                  D( PART_OFFSET+1 ), DU( PART_OFFSET+1 ), JA_NEW,
     $                  DESCA_1XP, B, IB, DESCB_PX1, AF, LAF, WORK,
     $                  LWORK, INFO )
*
...
*
         CALL PCDTTRSV( 'L', 'C', N, NRHS, DL( PART_OFFSET+1 ),
     $                  D( PART_OFFSET+1 ), DU( PART_OFFSET+1 ), JA_NEW,
     $                  DESCA_1XP, B, IB, DESCB_PX1, AF, LAF, WORK,
     $                  LWORK, INFO )
*
      ELSE
*
         CALL PCDTTRSV( 'U', 'N', N, NRHS, DL( PART_OFFSET+1 ),
     $                  D( PART_OFFSET+1 ), DU( PART_OFFSET+1 ), JA_NEW,
     $                  DESCA_1XP, B, IB, DESCB_PX1, AF, LAF, WORK,
     $                  LWORK, INFO )
*
