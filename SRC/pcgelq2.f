      SUBROUTINE PCGELQ2( M, N, A, IA, JA, DESCA, TAU, WORK, LWORK,
     $                    INFO )
      IMPLICIT NONE
*
...
*     .. External Subroutines ..
     ...
     $                   PCLACGV, PCLARF, PCLARFG, PB_TOPGET,
     $                   PB_TOPSET, PXERBLA
*     ..
*     .. External Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PCGELQ2', -INFO )
...
*        A(i,j+1:ja+n-1)
*
         CALL PCLACGV( N-J+JA, A, I, J, DESCA, DESCA( M_ ) )
         CALL PCLARFG( N-J+JA, AII, I, J, A, I, MIN( J+1, JA+N-1 ),
     $                 DESCA, DESCA( M_ ), TAU )
*
         IF( I.LT.IA+M-1 ) THEN
*
...
*
            ...
            CALL PCLARF( 'Right', M-I+IA-1, N-J+JA, A, I, J, DESCA,
     $                   DESCA( M_ ), TAU, A, I+1, J, DESCA, WORK )
         END IF
         CALL PCELSET( A, I, J, DESCA, AII )
         CALL PCLACGV( N-J+JA, A, I, J, DESCA, DESCA( M_ ) )
*
   10 CONTINUE
*
