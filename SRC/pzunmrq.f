      SUBROUTINE PZUNMRQ( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PZUNMRQ', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
     ...
     $    ( .NOT.LEFT .AND. NOTRAN ) ) THEN
         ...
         ELSE
            NI = N - K + IB
         END IF
         CALL PZUNMR2( SIDE, TRANS, MI, NI, IB, A, IA, JA, DESCA, TAU,
...
*
         CALL PZLARFT( 'Backward', 'Rowwise', NQ-K+I+IB-IA, IB,
...
*        Apply H or H'
*
         CALL PZLARFB( SIDE, TRANST, 'Backward', 'Rowwise', MI, NI,
