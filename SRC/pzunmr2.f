      SUBROUTINE PZUNMR2( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,
...
*     .. External Subroutines ..
     ...
     $                   PZELSET2, PZLACGV, PZLARF, PZLARFC
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PZUNMR2', -INFO )
...
*        Apply H(i) or H(i)'
*
         CALL PZLACGV( NQ-K+I-IA, A, I, JA, DESCA, DESCA( M_ ) )
         CALL PZELSET2( AII, A, I, JA+NQ-K+I-IA, DESCA, ONE )
         IF( NOTRAN ) THEN
            CALL PZLARFC( SIDE, MI, NI, A, I, JA, DESCA, DESCA( M_ ),
     $                    TAU, C, IC, JC, DESCC, WORK )
         ELSE
            CALL PZLARF( SIDE, MI, NI, A, I, JA, DESCA, DESCA( M_ ),
     $                   TAU, C, IC, JC, DESCC, WORK )
         END IF
         CALL PZELSET( A, I, JA+NQ-K+I-IA, DESCA, AII )
         CALL PZLACGV( NQ-K+I-IA, A, I, JA, DESCA, DESCA( M_ ) )
*
   10 CONTINUE
*
