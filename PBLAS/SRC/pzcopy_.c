...
*  =======
*
*  PZCOPY  copies one subvector into another,
*
*     sub( Y ) := sub( X ),
*
*  where
...
*/
   ...
   {
      PB_Cchkvec( ctxt, "PZCOPY", "X", *N, 1, Xi, Xj, Xd, *INCX,  5, &info );
      PB_Cchkvec( ctxt, "PZCOPY", "Y", *N, 1, Yi, Yj, Yd, *INCY, 10, &info );
   }
   if( info ) { PB_Cabort( ctxt, "PZCOPY", info ); return; }
#endif
/*
