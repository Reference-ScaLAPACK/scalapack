      SUBROUTINE ZMMDDACT( M, N, ALPHA, A, LDA, BETA, B, LDB )
*
...
*  =======
*
*  ZMMDDACT performs the following operation:
*
...
*
   ...
   20          CONTINUE
            ELSE IF( ALPHA.NE.ONE ) THEN
               DO 40 J = 1, N
                  DO 30 I = 1, M
                     A( I, J ) = DCONJG( B( J, I ) ) + ALPHA * A( I, J )
   30             CONTINUE
   40          CONTINUE
            ELSE
               DO 60 J = 1, N
                  DO 50 I = 1, M
                     A( I, J ) = DCONJG( B( J, I ) ) + A( I, J )
   50             CONTINUE
   60          CONTINUE
            END IF
...
* 150             CONTINUE
  ...
  180          CONTINUE
            ELSE IF( ALPHA.NE.ONE ) THEN
               DO 200 J = 1, M
                  DO 190 I = 1, N
                     A( J, I ) = DCONJG( B( I, J ) ) + ALPHA * A( J, I )
  190             CONTINUE
  200          CONTINUE
            ELSE
               DO 220 J = 1, M
                  DO 210 I = 1, N
                     A( J, I ) = DCONJG( B( I, J ) ) + A( J, I )
  210             CONTINUE
  220          CONTINUE
            END IF
         ELSE IF( BETA.NE.ZERO ) THEN
