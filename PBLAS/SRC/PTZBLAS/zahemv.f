      SUBROUTINE ZAHEMV( UPLO, N, ALPHA, A, LDA, X, INCX, BETA, Y,
     $                   INCY )
*
...
*     .. Local Scalars ..
      ...
      DOUBLE PRECISION   TALPHA, TEMP0, TEMP1, TEMP2
      COMPLEX*16         ZDUM
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
               DO 70, I = 1, J - 1
                  ...
                  IY      = IY      + INCY
   70          CONTINUE
               Y( JY ) = Y( JY ) + TEMP1 * ABS( DBLE( A( J, J ) ) ) +
     $                   ALPHA * TEMP2
               JX      = JX      + INCX
               JY      = JY      + INCY
*
