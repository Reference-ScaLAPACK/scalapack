...
*  =======
*
*  PSCNRM2  computes the 2-norm of a subvector sub( X ),
*
*  where
*
...
*/
   ...
   if( !( info = ( ( nprow == -1 ) ? -( 601 + CTXT_ ) : 0 ) ) )
      PB_Cchkvec( ctxt, "PSCNRM2", "X", *N, 1, Xi, Xj, Xd, *INCX, 6, &info );
   if( info ) { PB_Cabort( ctxt, "PSCNRM2", info ); return; }
#endif
/*
*  Initialize NORM2
*/
