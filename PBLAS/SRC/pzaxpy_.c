...
*  =======
*
*  PZAXPY  adds one subvector to another,
*
...
*/
   ...
   {
      PB_Cchkvec( ctxt, "PZAXPY", "X", *N, 1, Xi, Xj, Xd, *INCX,  6, &info );
      PB_Cchkvec( ctxt, "PZAXPY", "Y", *N, 1, Yi, Yj, Yd, *INCY, 11, &info );
   }
   if( info ) { PB_Cabort( ctxt, "PZAXPY", info ); return; }
#endif
/*
