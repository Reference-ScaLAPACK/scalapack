...
*  =======
*
*  PCBLA3TIM  is the main timing program for the Level 3 PBLAS routines.
*
...
*     .. External Subroutines ..
     ...
     $                   PB_TIMER, PCBLA3TIMINFO, PCGEADD, PCGEMM,
     $                   PCHEMM, PCHER2K, PCHERK, PCLAGEN, PCLASCAL,
     $                   PCSYMM, PCSYR2K, PCSYRK, PCTRADD, PCTRMM,
     $                   PCTRSM, PMDESCCHK, PMDIMCHK
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      ...
      CALL PCBLA3TIMINFO( OUTFILE, NOUT, NTESTS, DIAGVAL, SIDEVAL,
...
*
      END
      SUBROUTINE PCBLA3TIMINFO( SUMMRY, NOUT, NMAT, DIAGVAL, SIDEVAL,
...
*  =======
*
*  PCBLA3TIMINFO  get  the needed startup information for timing various
...
*
         OPEN( NIN, FILE='PCBLAS3TIM.dat', STATUS='OLD' )
         READ( NIN, FMT = * ) SUMMRY
         SUMMRY = ' '
*
