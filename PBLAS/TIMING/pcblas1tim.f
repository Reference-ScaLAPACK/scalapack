...
*  =======
*
*  PCBLA1TIM  is the main timing program for the Level 1 PBLAS routines.
*
...
*     .. Local Scalars ..
     ...
     $                   PISCLR, RSRCX, RSRCY
      REAL               PUSCLR
      DOUBLE PRECISION   ADDS, CFLOPS, MULTS, NOPS, WFLOPS
      COMPLEX            ALPHA, PSCLR
*     ..
*     .. Local Arrays ..
...
*     .. External Subroutines ..
     ...
     $                   PB_TIMER, PCAMAX, PCAXPY, PCBLA1TIMINFO,
     $                   PCCOPY, PCDOTC, PCDOTU, PCLAGEN, PCSCAL,
     $                   PCSSCAL, PCSWAP, PSCASUM, PSCNRM2, PVDESCCHK,
     $                   PVDIMCHK
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          DBLE, REAL
...
*
      ...
      CALL PCBLA1TIMINFO( OUTFILE, NOUT, NTESTS, NVAL, MXVAL, NXVAL,
...
*
      END
      SUBROUTINE PCBLA1TIMINFO( SUMMRY, NOUT, NMAT, NVAL, MXVAL, NXVAL,
...
*  =======
*
*  PCBLA1TIMINFO  get  the needed startup information for timing various
...
*
         OPEN( NIN, FILE='PCBLAS1TIM.dat', STATUS='OLD' )
         READ( NIN, FMT = * ) SUMMRY
         SUMMRY = ' '
*
