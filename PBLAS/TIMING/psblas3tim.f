...
*  =======
*
*  PSBLA3TIM  is the main timing program for the Level 3 PBLAS routines.
*
...
*     .. Parameters ..
     ...
     $                   ONE = 1.0E+0, TOTMEM = 2000000, NSUBS = 8,
...
*     .. External Subroutines ..
     ...
     $                   PB_TIMER, PMDESCCHK, PMDIMCHK, PSBLA3TIMINFO,
     $                   PSGEADD, PSGEMM, PSLAGEN, PSLASCAL, PSSYMM,
     $                   PSSYR2K, PSSYRK, PSTRADD, PSTRMM, PSTRSM
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      ...
      CALL PSBLA3TIMINFO( OUTFILE, NOUT, NTESTS, DIAGVAL, SIDEVAL,
...
*
     ...
     $             ( MAX( NROWA, NCOLA ).GT.1 ) ) THEN
                  ...
                  IF( LSAME( UPLO, 'L' ) ) THEN
                     CALL PSLASCAL( 'Lower', NROWA-1, NCOLA-1, SCALE,
     $                              MEM( IPA ), IA+1, JA, DESCA )
                  ELSE
                     CALL PSLASCAL( 'Upper', NROWA-1, NCOLA-1, SCALE,
...
*
      END
      SUBROUTINE PSBLA3TIMINFO( SUMMRY, NOUT, NMAT, DIAGVAL, SIDEVAL,
...
*  =======
*
*  PSBLA3TIMINFO  get  the needed startup information for timing various
...
*
         OPEN( NIN, FILE='PSBLAS3TIM.dat', STATUS='OLD' )
         READ( NIN, FMT = * ) SUMMRY
         SUMMRY = ' '
*
