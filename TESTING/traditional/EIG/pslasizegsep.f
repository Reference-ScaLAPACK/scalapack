*
*
      SUBROUTINE PSLASIZEGSEP( DESCA, IPREPAD, IPOSTPAD, SIZEMQRLEFT,
...
*  =======
*
*  PSLASIZEGSEP computes the amount of memory needed by
...
*               Array descriptor as passed to PSSYGVX
*
...
*
*  SIZECHK      LWORK for PSGSEPCHK
*
*  SIZESYEVX    LWORK for PSSYGVX
*
*  ISIZESYEVX   LIWORK for PSSYGVX
*
...
*
*     Allow room for IFAIL, ICLUSTR, and IWORK (all in PSSYGVX)
*
