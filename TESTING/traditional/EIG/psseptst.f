      SUBROUTINE PSSEPTST( DESCA, UPLO, N, MATTYPE, SUBTESTS, THRESH,
...
*  =======
*
*  PSSEPTST builds a random matrix, runs PSSYEVX and PSSYEV to
...
*          On normal exit from PSSYEVX, the first M entries
...
*     .. External Subroutines ..
     ...
     $                   PSLASET, PSLASIZESQP, PSLASIZESYEVX, PSLATMS, 
     $                   PSMATGEN, PSSEPSUBTST, PSSQPSUBTST, PSSYEV, 
     $                   SLABAD, SLASRT, SLATMS, SLCOMBINE
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $                  SIZESUBTST, ISIZESUBTST, SIZETST, ISIZETST )
*
...
*
         CALL PSSEPSUBTST( WKNOWN, 'v', 'a', UPLO, N, VL, VU, IL, IU,
...
*
            LSYEVXSIZE = VECSIZE
*
            CALL PSSEPSUBTST( .TRUE., JOBZ, RANGE, UPLO, N, VL, VU, IL,
...
*
     ...
     $         SUBTESTS
      ...
      END IF
*
*     Now that PSSYEVX been tested, we check PSSYEV if we are a
*     homogeneous machine.
*
...
*
            CALL PSSQPSUBTST( WKNOWN, JOBZ, UPLO, N, THRESH, ABSTOL, A,
...
*
     ...
     $                SUBTESTS
      ...
      END IF
*
*     Now that PSSYEV been tested, we check PSSYEVD if we are a
*     homogeneous machine.
*
      IF( LSAME( HETERO, 'N' ) .AND. LSAME( SUBTESTS, 'N' ) ) THEN
         PASSED = 'PASSED   EVD'
...
*
            CALL PSSDPSUBTST( WKNOWN, UPLO, N, THRESH, ABSTOL, A,
     $                        COPYA, Z, 1, 1, DESCA, WIN, WNEW, IPREPAD,
     $                        IPOSTPAD, WORK( INDWORK ), LLWORK,
...
*
 ...
 9980 FORMAT( ' Increase TOTMEM in PSSEPDRIVER' )
*
*     End of PSSEPTST
*
      END
