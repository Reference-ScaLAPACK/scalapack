      SUBROUTINE PSNEPINFO( SUMMRY, NOUT, NMAT, NVAL, LDNVAL, NNB,
...
*  =======
*
*  PSNEPINFO gets needed startup information for PDHSEQR drivers
...
*
     ...
     $      'real single precision Schur decomposition.'
