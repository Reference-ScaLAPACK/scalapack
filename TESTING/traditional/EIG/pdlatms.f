*
*
      SUBROUTINE PDLATMS( M, N, DIST, ISEED, SYM, D, MODE, COND, DMAX,
...
*  =======
*
*     PDLATMS generates random symmetric matrices with specified
*     eigenvalues for testing SCALAPACK programs.
*
*     PDLATMS operates by applying the following sequence of
*     operations:
*
...
*
*  WORK   - (local input/output) DOUBLE PRECISION array,
*           dimension (LWORK)
*
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, DLASET, DLATM1, DSCAL,
     $                   PCHK1MAT, PDLAGSY, PXERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( DESCA( CTXT_ ), 'PDLATMS', -INFO )
         RETURN
      END IF
*
...
*     symmetric -- A = U D U'
*
      CALL PDLAGSY( M, LLB, D, A, IA, JA, DESCA, ISEED, ORDER, WORK,
     $              LWORK, IINFO )
*
      RETURN
*
