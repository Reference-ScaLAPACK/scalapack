...
*  =======
*
*  PSLATRAN transpose a lower triangular matrix on to the upper
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, STRRV2D, STRSD2D
*     ..
*     .. External Functions ..
      INTEGER            NUMROC
      EXTERNAL           NUMROC
...
*
     ...
     $         CALL STRSD2D( ICTXT, 'U', 'N', IRECV, JRECV, WORK, IRECV,
     $                       MYCOL, MYROW )
*
            IF( ISEND.GT.0 .AND. JSEND.GT.0 )
     $         CALL STRRV2D( ICTXT, 'U', 'N', ISEND, JSEND,
