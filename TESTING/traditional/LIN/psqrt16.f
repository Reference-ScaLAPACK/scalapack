      SUBROUTINE PSQRT16( TRANS, M, N, NRHS, A, IA, JA, DESCA, X, IX,
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, PSASUM, PSGEMM, SGAMX2D
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
      IF( LSAME( TRANS, 'T' ) .OR. LSAME( TRANS, 'C' ) ) THEN
         ANORM = PSLANGE( 'I', M, N, A, IA, JA, DESCA, RWORK )
         N1 = N
         N2 = M
      ELSE
         ANORM = PSLANGE( '1', M, N, A, IA, JA, DESCA, RWORK )
         N1 = M
         N2 = N
      END IF
*
...
*     store in B.
*
      CALL PSGEMM( TRANS, 'No transpose', N1, NRHS, N2, -ONE, A, IA,
...
*
      ...
      DO 10 J = 1, NRHS
*
         CALL PSASUM( N1, BNORM, B, IB, JB+J-1, DESCB, 1 )
         CALL PSASUM( N2, XNORM, X, IX, JX+J-1, DESCX, 1 )
*
