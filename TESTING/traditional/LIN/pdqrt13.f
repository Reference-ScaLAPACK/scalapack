...
*  =======
*
*  PDQRT13 generates a full-rank matrix that may be scaled to have
*  large or small norm.
*
*  Notes
*  =====
...
*     .. Local Scalars ..
     ...
     $                   NPROW, NQ
      DOUBLE PRECISION   AJJ, ASUM, BIGNUM, SMLNUM
*     ..
*     .. External Functions ..
      INTEGER            NUMROC
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, INFOG2L, PDLABAD, PDLASCL,
     $                   PDMATGEN, PDASUM, PDELGET, PDELSET
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MOD, SIGN
*     ..
...
*
      DO 10 J = JA, JA+N-1
         I = IA + J - JA
         IF( I.LE.IA+M-1 ) THEN
            CALL PDASUM( M, ASUM, A, IA, J, DESCA, 1 )
            CALL PDELGET( 'Column', ' ', AJJ, A, I, J, DESCA )
...
*
      IF( SCALE.NE.1 ) THEN
*
         NORMA = PDLANGE( 'M', M, N, A, IA, JA, DESCA, WORK )
...
*           matrix scaled up
*
            CALL PDLASCL( 'General', NORMA, BIGNUM, M, N, A, IA,
     $                   JA, DESCA, INFO )
*
...
*           matrix scaled down
*
            CALL PDLASCL( 'General', NORMA, SMLNUM, M, N, A, IA,
     $                   JA, DESCA, INFO )
*
         END IF
*
      END IF
*
      NORMA = PDLANGE( 'One-norm', M, N, A, IA, JA, DESCA, WORK )
*
      RETURN
*
*     End of PDQRT13
