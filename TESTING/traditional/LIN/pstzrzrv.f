...
*  =======
*
*  PSTZRZRV computes sub( A ) = A(IA:IA+M-1,JA:JA+N-1) from T, Z
*  computed by PSTZRZF.
*
*  Notes
*  =====
...
*          by PSTZRZF. On exit, the original matrix is restored.
*
...
*
*  TAU     (local input) REAL, array, dimension LOCr(M_A).
*          This array contains the scalar factors TAU of the elementary
*          reflectors computed by PSTZRZF. TAU is tied to the dis-
*          tributed matrix A.
*
...
*     .. External Subroutines ..
     ...
     $                   PSLARZB, PSLARZT, PSLASET, PB_TOPGET,
     $                   PB_TOPSET
*     ..
*     .. External Functions ..
...
*        Compute upper triangular matrix T
*
         CALL PSLARZT( 'Backward', 'Rowwise', L, IB, A, I, JM1, DESCA,
     $                 TAU, WORK( IPT ), WORK( IPW ) )
*
*        Copy Householder vectors into workspace
*
         CALL PSLACPY( 'All', IB, L, A, I, JM1, DESCA, WORK( IPV ), 1,
     $                 JV, DESCV )
*
*        Save temporarily strict lower part of A(I:I+IB-1,J:J+IB-1 )
*
         CALL PSLACPY( 'Lower', IB-1, IB-1, A, I+1, JA+I-IA, DESCA,
     $                 WORK( IPV ), 1, ICOFF+1+I-IA, DESCV )
*
*        Zeoes the row panel of sub( A ) to get T(IA:I-1,JA+I-IA:JA+N-1)
*
         CALL PSLASET( 'All', IB, L, ZERO, ZERO, A, I, JM1, DESCA )
         CALL PSLASET( 'Lower', IB-1, IB-1, ZERO, ZERO, A, I+1, JA+I-IA,
     $                 DESCA )
*
*        Apply block Householder transformation
*
     ...
     $                 WORK( IPW ) )
*
         CALL PSLACPY( 'Lower', IB-1, IB-1, WORK( IPV ), 1,
