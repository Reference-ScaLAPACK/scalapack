      SUBROUTINE PSLLTINFO( SUMMRY, NOUT, UPLO, NMAT, NVAL, LDNVAL, NNB,
...
*  =======
*
*  PSLLTINFO get needed startup information for LLt factorization
...
*
     ...
     $                   'real single precision LLt factorization '//
     $                   'and solve.'
         WRITE( NOUT, FMT = 9999 )
